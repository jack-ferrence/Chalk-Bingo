      ...
      {user && (
        ...
        >
          ...
          <p
            ...
            style={{ color: '#94A3B8', maxWidth: 160 }}
          >
            {displayName}
          </p>
        </div>
      ...
      >
        ...
        {user && (
          <button
            ...
            style={{ color: '#334155', background: 'none', border: 'none', cursor: 'pointer', padding: 0 }}
        ...
        <p className="text-[10px]" style={{ color: '#1E293B' }}>Chalk v0.1</p>
      </div>
    </div>
  )
}
