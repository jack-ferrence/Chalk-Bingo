      ...
      <div className="flex h-14 items-center justify-between px-4">
        ...
        <div className="flex items-center gap-3">
          <button
            type="button"
            onClick={onMenuClick}
            className="md:hidden rounded p-1.5 transition-colors hover:bg-[#1A2235]"
            style={{ color: '#64748B' }}
        ...
        {loading ? null : user ? (
            ...
            {dropdownOpen && (
              <>
                ...
                <div
                  ...
                  style={{ background: '#1A2235', border: '1px solid #1E293B' }}
                >
                  <button
                    type="button"
          ...
          <div className="flex items-center gap-2">
            <Link
              to="/login"
              className="text-sm transition-colors hover:text-[#F1F5F9]"
              style={{ color: '#64748B' }}
            >
              Log in
            </Link>
            <Link
              to="/register"
              className="rounded-lg px-4 py-1.5 text-xs font-bold transition-all hover:bg-[#69F0AE]"
              style={{ background: '#00E676', color: '#0A0E17' }}
            >
              Sign up
            </Link>
